...
body{margin:0;min-height:100vh;color:var(--ink);font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;background:var(--bg);overflow-x:hidden;font-size:14px;line-height:1.5;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility}
a{color:var(--brand-dark);font-weight:700;text-underline-offset:2px}.app{min-height:100vh}.side{position:fixed;inset:0 auto 0 0;width:var(--side);z-index:20;display:flex;flex-direction:column;background:#fff;border-right:1px solid var(--line);box-shadow:1px 0 0 rgba(15,23,42,.02)}
.logo{height:56px;display:flex;align-items:center;gap:12px;padding:0 18px;border-bottom:1px solid var(--line-soft);font-weight:800;font-size:15px;letter-spacing:-.035em;color:#0f172a;white-space:nowrap}.logo span{display:flex;flex-direction:column;line-height:1.05}.logo span:after{content:'HEALTH PERFORMANCE OS';font-size:10px;letter-spacing:.10em;color:var(--muted2);font-weight:800;margin-top:4px}.mark{width:28px;height:28px;border-radius:7px;background:var(--brand);box-shadow:none;position:relative;flex:0 0 auto}.mark:after{content:'⌁';position:absolute;inset:0;display:grid;place-items:center;color:#fff;font-weight:900;font-size:17px}.nav{display:flex;flex-direction:column;gap:3px;padding:12px}.nav a{display:flex;align-items:center;gap:10px;color:#475569;text-decoration:none;padding:9px 10px;border-radius:9px;font-weight:650;font-size:13px;border:1px solid transparent;white-space:nowrap;transition:background .15s,color .15s}.nav a:before{content:'◦';color:#94a3b8;font-size:18px;line-height:0}.nav a:hover{background:#f8fafc;color:#0f172a}.nav a.active{background:var(--brand-soft);border-color:transparent;color:#1e40af}.nav a.active:before{color:var(--brand)}.side>.footer{margin-top:auto;padding:18px 16px;border-top:1px solid var(--line-soft);font-size:11px;line-height:1.55;color:#94a3b8;background:#fff}.main{margin-left:var(--side);padding:30px 28px 46px;max-width:none;min-width:0}.main:before{content:'Health OS dashboard';position:fixed;top:12px;right:28px;z-index:30;background:rgba(255,255,255,.92);border:1px solid var(--line);border-radius:10px;padding:8px 14px;color:#475569;font-size:13px;font-weight:650;box-shadow:0 1px 2px rgba(15,23,42,.04);backdrop-filter:blur(10px)}
.hero{display:grid;grid-template-columns:minmax(0,1fr) minmax(360px,.62fr);gap:16px;margin:0 auto 16px;max-width:var(--max);align-items:start}.heroCard,.coach,.card{min-width:0;overflow:hidden;background:var(--panel);border:1px solid var(--line);border-radius:var(--radius);box-shadow:var(--shadow)}.heroCard{padding:26px 28px;background:linear-gradient(180deg,#fff 0%,#fbfdff 100%)}.coach{padding:0}.eyebrow{font-size:11px;letter-spacing:.12em;text-transform:uppercase;color:var(--muted2);font-weight:800;margin-bottom:10px}.hero h1{font-size:30px;line-height:1.06;margin:0 0 9px;letter-spacing:-.055em;color:#0f172a}.hero p{margin:0 0 18px;color:#64748b;max-width:780px;line-height:1.62}.coach h2,.card h2{margin:0;padding:16px 20px 12px;font-size:15px;line-height:1.15;letter-spacing:-.035em;color:#0f172a;border-bottom:1px solid var(--line-soft);font-weight:750}.coach #coachPlan{padding:8px 20px 18px}.grid{display:grid;gap:16px;max-width:var(--max);margin-left:auto;margin-right:auto}.metrics{grid-template-columns:repeat(4,minmax(0,1fr));margin-bottom:18px}.section{margin-top:18px}.two{grid-template-columns:minmax(0,1fr) minmax(0,1fr)}.charts{grid-template-columns:minmax(0,1fr) minmax(0,1fr)}.card{padding:0}.card:not(:has(h2)){padding:18px 20px}.metrics .card{padding:18px 20px;min-height:116px;box-shadow:0 1px 2px rgba(15,23,42,.03)}.metricLabel{font-size:10.5px;line-height:1.35;letter-spacing:.09em;text-transform:uppercase;color:var(--muted2);font-weight:800;margin-bottom:7px}.metricVal{font-size:30px;line-height:1.05;letter-spacing:-.055em;font-weight:850;color:#0f172a;font-variant-numeric:tabular-nums}.metricVal.good{color:var(--good)}.metricVal.warn{color:var(--warn)}.metricVal.bad{color:var(--bad)}.metricVal.brand{color:var(--brand-dark)}.metricDelta{font-size:12px;color:#64748b;margin-top:7px}.pill{display:inline-flex;align-items:center;border-radius:999px;padding:3px 8px;background:var(--brand-soft);border:1px solid var(--brand-line);color:#1d4ed8;font-size:11px;font-weight:750;white-space:nowrap}#heroPills{display:flex;flex-wrap:wrap;gap:6px}.insight{display:grid;grid-template-columns:10px minmax(0,1fr);gap:10px;padding:12px 0;border-bottom:1px solid var(--line-soft)}.insight:last-child{border-bottom:0}.insight h3{margin:0 0 4px;font-size:13px;line-height:1.25;color:#0f172a;letter-spacing:-.02em}.insight p{margin:0;color:#64748b;font-size:12.5px;line-height:1.55}.dot{width:8px;height:8px;border-radius:999px;margin-top:5px;background:var(--brand)}.dot.win,.dot.performance{background:var(--good)}.dot.watch{background:var(--warn)}.dot.pattern{background:var(--purple)}.dot.focus{background:var(--brand)}.note{color:#64748b;font-size:12px;line-height:1.55;margin:12px 20px 18px}.table{width:100%;border-collapse:collapse;font-size:12.5px}.table th{background:#f8fafc;color:#64748b;text-transform:uppercase;font-size:10px;letter-spacing:.08em;text-align:left;font-weight:800}.table th,.table td{border-bottom:1px solid var(--line-soft);padding:10px 14px;vertical-align:top}.table td{color:#334155}.table tr:hover td{background:#fbfdff}canvas{width:100%!important;max-height:360px;padding:16px 18px 12px}.zonebar{display:grid;grid-template-columns:70px 1fr 48px;gap:10px;align-items:center;padding:9px 20px;border-bottom:1px solid var(--line-soft);font-size:12px;color:#475569}.bar{height:8px;border-radius:999px;background:#e2e8f0;overflow:hidden}.fill{height:100%;border-radius:inherit;background:var(--brand)}body>.footer,.main>.footer{max-width:var(--max);margin:20px auto 0;color:#94a3b8;font-size:11px;line-height:1.6}.tnum{font-variant-numeric:tabular-nums}.skeleton{border-radius:var(--radius);background:linear-gradient(90deg,#f1f5f9,#e2e8f0,#f1f5f9);background-size:200% 100%;animation:sk 1.2s infinite linear}@keyframes sk{to{background-position:-200% 0}}
@media(max-width:980px){:root{--side:0px}.side{position:sticky;top:0;width:auto;height:auto;inset:auto;flex-direction:column;border-right:0;border-bottom:1px solid var(--line);overflow:hidden}.logo{width:100%;background:#fff}.nav{width:100%;flex-direction:row;overflow-x:auto;overflow-y:hidden;padding:8px 12px;-webkit-overflow-scrolling:touch;scrollbar-width:none}.nav::-webkit-scrollbar{display:none}.nav a{font-size:12px;padding:7px 9px;flex:0 0 auto}.side>.footer{display:none}.main{margin-left:0;padding:22px 10px 40px}.main:before{display:none}.hero,.two,.charts{grid-template-columns:1fr}.metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.heroCard{padding:22px 18px}.hero h1{font-size:26px}.table{display:block;overflow:auto;white-space:nowrap}.table thead,.table tbody,.table tr{width:100%}}
@media(max-width:560px){.metrics{grid-template-columns:1fr}.metricVal{font-size:28px}.coach h2,.card h2{padding:14px 16px}.table th,.table td{padding:9px 14px}.main{padding-left:10px;padding-right:10px}.hero{gap:12px}.grid{gap:12px}.section{margin-top:12px}}
</style></head><body><div class="app"><aside class="side"><div class="logo"><div class="mark"></div><span>David Health OS</span></div><nav class="nav"><a class="active" href="#overview">Overview</a><a href="#coach">Coach</a><a href="#patterns">Patterns</a><a href="#sutter">Sutter</a><a href="#bodycomp">Body comp</a><a href="#supplies">Supplies</a><a href="#training">Training</a><a href="#glucose">Glucose</a></nav><div class="footer" id="meta"></div></aside><main class="main">
...
<section class="grid two section" id="sutter"><div class="card"><h2>Sutter clinical context</h2><div id="sutterSummary"></div></div><div class="card"><h2>A1c history</h2><canvas id="a1cChart"></canvas><div class="note">Clinical lab history from Sutter export. Review trends with clinician; not dosing guidance.</div></div></section>
...
async function main(){chartDefaults(); const data=await fetch('./data.json?v=20260729-pitchmap-theme', {cache:'no-store'}).then(r=>r.json()); const s=data.summary30, a=data.analytics, days=data.daily90, joined=data.joined30, dexa=data.dexa||{}, scans=(data.dexa&&data.dexa.scans)||[], latestDexa=(data.dexa&&data.dexa.latest)||{}, supplyList=(data.supplies&&data.supplies.supplies)||[], nextSupply=(data.supplies&&data.supplies.summary&&data.supplies.summary.next_item)||null, sutter=data.sutter||{}, sm=sutter.latest_metrics||{};
 ...
 document.getElementById('heroPills').innerHTML=[`GMI ${fmt(s.gmi)}%`,`CV ${fmt(s.avg_cv_pct)}%`,sm.a1c_percent?`Sutter A1c ${sm.a1c_percent.raw_value}`:null,`${s.workout_count} workouts`,`Sleep ${fmt(s.avg_sleep_performance)}%`, latestDexa.body_fat_pct!=null?`DEXA ${fmt(latestDexa.body_fat_pct)}% BF`:null, nextSupply?`${nextSupply.item}: ${nextSupply.urgency_label}`:null].filter(Boolean).map(x=>`<span class="pill">${x}</span>`).join('');
 ...
 if(sutter.available){
  const metricLine=(label,obj,unit='')=>obj?`<tr><td>${label}</td><td>${obj.raw_value||fmt(obj.value)}${unit}</td><td>${obj.date||''}</td><td>${obj.reference||''}</td></tr>`:'';
  document.getElementById('sutterSummary').innerHTML=`<table class="table"><thead><tr><th>Metric</th><th>Value</th><th>Date</th><th>Reference</th></tr></thead><tbody>${[
    metricLine('A1c',sm.a1c_percent),metricLine('Avg glucose from A1c',sm.estimated_avg_glucose_mg_dl,' mg/dL'),metricLine('LDL',sm.ldl_calculated_mg_dl,' mg/dL'),metricLine('HDL',sm.hdl_mg_dl,' mg/dL'),metricLine('Triglycerides',sm.triglycerides_mg_dl,' mg/dL'),metricLine('Creatinine',sm.creatinine_mg_dl,' mg/dL'),metricLine('eGFR',sm.egfr),metricLine('Microalbumin urine',sm.microalbumin_urine_mg_l,' mg/L')].join('')}</tbody></table><p class="note">Sanitized Sutter export context only. Raw Sutter files remain private/local and should not be published with PHI.</p>`;
  const a1cHist=(sutter.a1c_history||[]).slice().reverse();
  new Chart(a1cChart,{type:'line',data:{labels:a1cHist.map(x=>x.date),datasets:[{label:'A1c %',data:a1cHist.map(x=>x.value),borderColor:'#25d6c8',backgroundColor:'#25d6c822',tension:.25,pointRadius:4}]},options:{responsive:true,scales:{y:{title:{display:true,text:'A1c %'}}}}});
 } else {
  document.getElementById('sutterSummary').innerHTML='<p class="note">No Sutter clinical metrics loaded yet.</p>';
 }
...
main().then(()=>{
  // Chart.js can occasionally initialize before final responsive layout settles on GitHub Pages.
  // Force a post-layout draw so canvases are visible on first load, desktop and mobile.
  setTimeout(()=>Object.values(Chart.instances||{}).forEach(ch=>{ch.resize(); ch.update('none');}), 120);
});
</script></body></html>'''
