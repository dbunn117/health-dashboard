...
body{margin:0;min-height:100vh;color:var(--ink);font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;background:var(--bg);overflow-x:hidden;font-size:14px;line-height:1.5}
...
.logo{height:56px;display:flex;align-items:center;gap:12px;padding:0 18px;border-bottom:1px solid var(--line);font-weight:850;font-size:15px;letter-spacing:-.035em;color:#08111f;white-space:nowrap}.logo span{display:flex;flex-direction:column;line-height:1.05}.logo span:after{content:'HEALTH PERFORMANCE OS';font-size:10px;letter-spacing:.08em;color:var(--muted2);font-weight:800;margin-top:4px}.mark{width:28px;height:28px;border-radius:8px;background:var(--brand);box-shadow:0 8px 18px rgba(22,163,74,.18);position:relative;flex:0 0 auto}.mark:after{content:'⌁';position:absolute;inset:0;display:grid;place-items:center;color:#fff;font-weight:900;font-size:17px}.nav{display:flex;flex-direction:column;gap:4px;padding:12px}.nav a{display:flex;align-items:center;gap:10px;color:#34445f;text-decoration:none;padding:9px 10px;border-radius:8px;font-weight:750;font-size:13px;border:1px solid transparent;white-space:nowrap}.nav a:before{content:'◦';color:#8fa0b7;font-size:18px;line-height:0}.nav a:hover,.nav a.active{background:var(--brand-soft);border-color:transparent;color:#0b6f33}.nav a.active:before{color:var(--brand)}.side>.footer{margin-top:auto;padding:18px 16px;border-top:1px solid var(--line-soft);font-size:11px;line-height:1.55;color:#8a99af;background:#fbfcfe}.main{margin-left:var(--side);padding:30px 28px 46px;max-width:none;min-width:0}.main:before{content:'Health OS dashboard';position:fixed;top:12px;right:28px;z-index:30;background:#fff;border:1px solid var(--line);border-radius:9px;padding:8px 14px;color:#34445f;font-size:13px;font-weight:750;box-shadow:var(--shadow)}
.hero{display:grid;grid-template-columns:minmax(0,1fr) minmax(360px,.62fr);gap:16px;margin:0 auto 16px;max-width:var(--max);align-items:start}.heroCard,.coach,.card{min-width:0;overflow:hidden;background:var(--panel);border:1px solid var(--line);border-radius:var(--radius);box-shadow:var(--shadow)}.heroCard{padding:24px 26px}.coach{padding:0}.eyebrow{font-size:11px;letter-spacing:.1em;text-transform:uppercase;color:var(--muted2);font-weight:850;margin-bottom:10px}.hero h1{font-size:24px;line-height:1.12;margin:0 0 8px;letter-spacing:-.04em;color:#071122}.hero p{margin:0 0 18px;color:#5b6c86;max-width:780px;line-height:1.6}.coach h2,.card h2{margin:0;padding:16px 20px 12px;font-size:16px;line-height:1.15;letter-spacing:-.035em;color:#071122;border-bottom:1px solid var(--line-soft)}.coach #coachPlan{padding:8px 20px 18px}.grid{display:grid;gap:16px;max-width:var(--max);margin-left:auto;margin-right:auto}.metrics{grid-template-columns:repeat(4,minmax(0,1fr));margin-bottom:18px}.section{margin-top:18px}.two{grid-template-columns:minmax(0,1fr) minmax(0,1fr)}.charts{grid-template-columns:minmax(0,1fr) minmax(0,1fr)}.card{padding:0}.card:not(:has(h2)){padding:18px 20px}.metrics .card{padding:18px 20px}.metricLabel{font-size:11px;line-height:1.35;letter-spacing:.08em;text-transform:uppercase;color:var(--muted2);font-weight:850;margin-bottom:6px}.metricVal{font-size:30px;line-height:1.05;letter-spacing:-.045em;font-weight:900;color:#071122}.metricVal.good{color:var(--good)}.metricVal.warn{color:var(--warn)}.metricVal.bad{color:var(--bad)}.metricVal.brand{color:var(--brand-dark)}.metricDelta{font-size:12px;color:#536781;margin-top:6px}.pill{display:inline-flex;align-items:center;border-radius:999px;padding:3px 8px;background:var(--brand-soft);border:1px solid var(--brand-line);color:#087232;font-size:11px;font-weight:800;white-space:nowrap}#heroPills{display:flex;flex-wrap:wrap;gap:6px}.insight{display:grid;grid-template-columns:10px minmax(0,1fr);gap:10px;padding:12px 0;border-bottom:1px solid var(--line-soft)}.insight:last-child{border-bottom:0}.insight h3{margin:0 0 4px;font-size:14px;letter-spacing:-.02em;color:#071122;display:flex;gap:8px;align-items:center;flex-wrap:wrap}.insight p{margin:0;color:#263852;line-height:1.55}.dot{width:6px;height:6px;border-radius:999px;background:var(--brand);margin-top:8px}.dot.watch{background:var(--warn)}.dot.bad{background:var(--bad)}.dot.pattern{background:#2563eb}.dot.performance{background:#7c3aed}.dot.win,.dot.focus{background:var(--brand)}.table{width:100%;border-collapse:collapse;font-size:13px}.table th{background:#fbfcfe;color:#8b9ab1;text-align:left;font-size:11px;letter-spacing:.08em;text-transform:uppercase;font-weight:850;padding:10px 20px;border-bottom:1px solid var(--line-soft)}.table td{padding:10px 20px;border-bottom:1px solid var(--line-soft);color:#20334f;vertical-align:top}.table tr:last-child td{border-bottom:0}.note{color:#6a7a92;font-size:12px;line-height:1.55;padding:12px 20px 16px;margin:0}canvas{width:100%!important;max-height:330px;padding:12px 16px 18px}.zonebar{display:grid;grid-template-columns:64px 1fr 42px;align-items:center;gap:10px;padding:10px 20px;border-bottom:1px solid var(--line-soft);color:#263852}.zonebar:last-child{border-bottom:0}.bar{height:9px;border-radius:999px;background:#edf2f7;overflow:hidden}.fill{height:100%;border-radius:999px;background:linear-gradient(90deg,var(--brand),#22c55e)}.main>.footer{max-width:var(--max);margin:22px auto 0;color:#708098;font-size:12px;line-height:1.55;background:#fff;border:1px solid var(--line);border-radius:var(--radius);padding:14px 16px;box-shadow:var(--shadow)}
@media(max-width:980px){:root{--side:0px}.side{position:sticky;top:0;width:auto;height:auto;inset:auto;flex-direction:column;border-right:0;border-bottom:1px solid var(--line)}.logo{width:100%}.nav{width:100%;flex-direction:row;overflow:auto;padding:8px 12px}.nav a{font-size:12px;padding:7px 9px}.side>.footer{display:none}.main{margin-left:0;padding:22px 14px 40px}.main:before{display:none}.hero,.two,.charts{grid-template-columns:1fr}.metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.heroCard{padding:22px 18px}.hero h1{font-size:26px}.table{display:block;overflow:auto;white-space:nowrap}.table thead,.table tbody,.table tr{width:100%}}
...
async function main(){chartDefaults(); const data=await fetch('./data.json?v=20260715-sutter', {cache:'no-store'}).then(r=>r.json()); const s=data.summary30, a=data.analytics, days=data.daily90, joined=data.joined30, dexa=data.dexa||{}, scans=(data.dexa&&data.dexa.scans)||[], latestDexa=(data.dexa&&data.dexa.latest)||{}, supplyList=(data.supplies&&data.supplies.supplies)||[], nextSupply=(data.supplies&&data.supplies.summary&&data.supplies.summary.next_item)||null, sutter=data.sutter||{}, sm=sutter.latest_metrics||{};
